...
public final class RegUtils {
	 ...
	 * 
	 */
	public static final String EMAIL_REGEXP = "[a-zA-Z_]{1,}[0-9]{0,}@(([a-zA-z0-9]-*){1,}\\.){1,3}[a-zA-z\\-]{1,}";
	 ...
	 */
	   public static boolean regCheck(String str,String regEx ){
		...
		public static void main(String[] args) {
			...
			System.out.println(RegUtils.regCheck("foo@bar.com", RegUtils.EMAIL_REGEXP));
